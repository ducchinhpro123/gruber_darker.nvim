...
local fg = hsl(240, 25, 91) -- #d9e0ff
local fg_light = hsl(240, 100, 97) -- #f2f2ff
local fg_lighter = hsl(0, 0, 96) -- #f5f5f5
local white = hsl(0, 0, 100) -- #ffffff
local black = hsl(0, 0, 0) -- #000000
local bg_dark = hsl(240, 14, 5) -- #0d0d1a
local bg = hsl(0, 0, 6.27) -- #101010
local bg_light = hsl(240, 14, 15) -- #262640
local bg2 = hsl(240, 14, 17) -- #2b2b47
local bg3 = hsl(240, 14, 28) -- #47475e
local bg4 = hsl(240, 14, 31) -- #4f4f66
local red_dark = hsl(359, 55, 50) -- #d94c4c
local red = hsl(357, 89, 58) -- #ff4d4d
local red_light = hsl(357, 100, 65) -- #ff6666
local green = hsl(82.5, 60.0, 50.2) -- #73c936
local yellow = hsl(48.0, 100.0, 60.0) -- #ffdd33
local brown = hsl(33, 58, 51) -- #cc8533
local quartz = hsl(150, 10, 62) -- #9ea9a9
local niagara_darker = hsl(221, 14, 22) -- #2e3a4a
local niagara_dark = hsl(221, 14, 39) -- #637a8a
local niagara = hsl(221, 31, 68) -- #a3c1d9
local wisteria = hsl(251, 30, 68) -- #a3a3d9
